...
def validate(data: Any) -> list[str]:
    ...
    if next_phase and "$author-aster-diagnostics" not in next_phase:
        add(errors, "$.next_phase", "must name $author-aster-diagnostics")
    return errors
...
def valid_fixture() -> dict[str, Any]:
    ...
    return {
        ...
        "unresolved_warnings": [],
        "next_phase": "Run $author-aster-diagnostics with this handoff.",
    }
