	...
	d := &models.JobDetail{
		Runs: []models.BuildResult{{
			...
			TestCases: []models.TestCase{{
				...
				AIAnalysis:      &models.AIAnalysis{Severity: "high", RelevantFiles: []string{"test/e2e/config/azure-dev.yaml"}, Disposition: models.AnalysisDispositionCitationsVerified},
			}},
		}},
	}
