...
func TestBuildUsageReportHistoricalDaysAndCurrentRepricing(t *testing.T) {
	...
	ledgers := []aiusage.UsageLedger{{Version: aiusage.LedgerVersion, Currency: "USD", Days: []aiusage.DailyUsage{
		...
		day("2026-08-08", aiusage.UsageTotals{Operations: 1, ExternalUnmeteredOperations: 1}, map[aiusage.Feature]aiusage.UsageTotals{aiusage.FeatureAnalysisChat: {Operations: 1, ExternalUnmeteredOperations: 1}}),
